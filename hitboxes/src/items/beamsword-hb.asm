//bass-n64
//=== Beam Sword Hitbox Display ===============================================
//  Render the beam sword's model and/or hitboxes. Identical to other item
// hitbox routines, except for the model rendering routine
// Make this routine aware of the data.hitboxFlags flag state
//==============================================================================

// Replace the entire routine from 80171D38 to 80171DF0
pushvar pc
origin  0xEC778
base    0x80171D38
...
scope drawBeamSword: {
  ...
  constant  drawBeamSwordModel(0x80014768)
  ...
  nopUntilPC(0x80171DF0, "Replacement drawBeamSword Routine Overflow")
}
pullvar pc

if {defined v} {        // Verbose Print info [-d v on cli]
  print "included beamsword-hb.asm \n"
}
